...
{{
$Medicament }}
 <form id="formID" action="{{route('Medicament.update',$Medicament->id)}}" method="post">
 @csrf
 @method('PUT')
              ...
              <div class="input-group">
                  ...
                  <input name="libelle"  value="{{old('libelle')}}" type="text" placeholder="" class="form-control
                  validate[required]" />
              </div><br>
               <label class="">description : <span style="color:red; font-weight: bold; font-family: Arial, sans-serif ;">(*)</span></label>
              <div class="input-group">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                  <input name="description" value="{{old('description')}}"  type="text" placeholder="" class="form-control
                  validate[required]" />
              </div><br>
            <label class="input-group">PRIX : <span style="color:red; font-weight: bold; font-family: Arial, sans-serif ;">(*)</span></label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
                                <input name="prix" value="{{old('prix')}}" type="text" placeholder="" class="form-control validate[required]" />
                            </div><br>
                            ...
                            <label class="input-group">DATE PERAMPTION : <span style="color:red; font-weight: bold; font-family: Arial, sans-serif ;">(*)</span></label>
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
                                                            <input name="peram"  type="date" placeholder=""
