...
<h1>EDITER  PERSONNE</h1>
 <form id="formID" action="{{route('personnel.update',$personnel->id)}}" method="post">
 @csrf
 @method('PUT')
              ...
              <div class="input-group">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                  <input name="prenom" type="text" value="" placeholder="" class="form-control validate[required]" />
              </div><br>
              ...
              <label class="input-group">NUMERO : <span style="color:red; font-weight: bold; font-family: Arial, sans-serif ;">(*)</span></label>
                            <div class="input-group">
                                ...
                                <input name="numero" type="text" value="" placeholder="" class="form-control validate[required]" />
                            </div><br>
                              <label class="input-group">adresse : <span style="color:red; font-weight: bold; font-family: Arial, sans-serif ;">(*)</span></label>
                                          <div class="input-group">
                                              <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
                                    <input name="adress" type="text" value=""placeholder="" class="form-control validate[required]" /></div><br>
               <label class="">Email : <span style="color:red; font-weight: bold; font-family: Arial, sans-serif ;">(*)</span></label>
              <div class="input-group">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
                  <input name="mail" type="text"value="" placeholder="" class="form-control validate[required]" />
              </div>
              <br>
